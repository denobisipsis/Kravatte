...
*/		   					
   ...
   function Ro_Pi(&$lanes)
    ...
    function Iota(&$lanes,$round)
    	{
	$RCC = [
	"\x0a\x80\x00\x00\x00\x00\x00\x00",
	"\x0a\x00\x00\x80\x00\x00\x00\x80",
	"\x81\x80\x00\x80\x00\x00\x00\x80",
	"\x80\x80\x00\x00\x00\x00\x00\x80",
	"\x01\x00\x00\x80\x00\x00\x00\x00",
	"\x08\x80\x00\x80\x00\x00\x00\x80"];
